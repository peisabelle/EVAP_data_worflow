...
def retrieve_ERA5land_FM(dates, dest_folder):
    ...
    bounding_rectangle = [48, -72, 46,-70] # North, West, South, East.
    variables = [
        # Snow variables
        #'snow_cover',
        #'snow_density',
...
dates = {'start':'2024-04-01','end':'2025-04-02'}
